...
//		try {
//			MainMenu2.con =  (Connection) DriverManager.getConnection(URL, dbUser, dbPassword);
//			MainMenu2.stat =  (Statement) MainMenu2.con.createStatement();
...
//		UIManager.setLookAndFeel("com.seaglasslookandfeel.SeaGlassLookAndFeel");
	...
	try {
		...
		lblPetuags.setBounds(62, 232, 86, 39);
		...
		label_2.setBounds(10, 228, 51, 43);
		...
		lblSuratMasuk.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				desktopPane.removeAll();
				SuratMasuk2 sm = new SuratMasuk2();
				desktopPane.add(sm);
				sm.setVisible(true);
			}
		});
		...
		lblSuratMasuk.setBounds(62, 282, 118, 43);
		...
		label_3.setBounds(10, 282, 51, 43);
		...
		lblSuratKeluar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				desktopPane.removeAll();
				SuratKeluar2 sk = new SuratKeluar2();
				desktopPane.add(sk);
				sk.setVisible(true);
			}
		});
		...
		lblSuratKeluar.setBounds(62, 336, 118, 43);
		...
		label_4.setBounds(10, 336, 51, 43);
		...
		lblDisposisi.setBounds(62, 390, 118, 43);
		...
		label_5.setBounds(10, 398, 51, 25);
		...
		lblLaporanSuratMasuk.setBounds(62, 444, 167, 43);
		...
		label_6.setBounds(10, 444, 51, 43);
		...
		lblLaporanSuratKeluar.setBounds(62, 498, 167, 43);
		...
		label_7.setBounds(10, 498, 51, 43);
		...
		lblBeranda.setBounds(62, 190, 68, 27);
		...
		lblTentangAplikasi.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		...
		lblTentangAplikasi.setForeground(Color.WHITE);
		lblTentangAplikasi.setFont(new Font("Palatino Linotype", Font.BOLD, 16));
		lblTentangAplikasi.setBounds(62, 552, 167, 43);
		contentPane.add(lblTentangAplikasi);
		
		JLabel label_9 = new JLabel("");
		label_9.setIcon(new ImageIcon("D:\\''SMK 5 Telkom''\\Belajar PBO\\new\\Pengarsipan\\src\\images\\About.png"));
		label_9.setHorizontalAlignment(SwingConstants.CENTER);
		label_9.setBounds(10, 552, 51, 43);
